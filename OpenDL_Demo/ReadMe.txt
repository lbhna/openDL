================================================================================
    MICROSOFT 基础类库： OpenDL_Demo 项目概述
===============================================================================

应用程序向导已为您创建了此 OpenDL_Demo 应用程序。此应用程序
不仅介绍了使用 Microsoft 基础类的基本知识，
而且是编写应用程序的起点。

此文件包含组成 OpenDL_Demo 应用程序的每个文件的内容摘要。
...
OpenDL_Demo.h
    ...
    COpenDL_DemoApp 应用程序类。

OpenDL_Demo.cpp
    这是包含应用程序
    类 COpenDL_DemoApp 的主应用程序源文件。
...
res\Toolbar.bmp
    ...
    更新 OpenDL_Demo.rc 中的 IDR_MAINFRAME TOOLBAR 数组以添加
    工具栏按钮。
/////////////////////////////////////////////////////////////////////////////

应用程序向导将创建一种文档类型和一个视图：

OpenDL_DemoDoc.h、OpenDL_DemoDoc.cpp - 文档
    这些文件包含 COpenDL_DemoDoc 类。  编辑这些文件
    以添加特殊的文档数据并实现文件的保存和加载
    （通过 COpenDL_DemoDoc::Serialize）。
OpenDL_DemoView.h、OpenDL_DemoView.cpp - 文档视图
    这些文件包含 COpenDL_DemoView 类。
    COpenDL_DemoView 对象用于查看 COpenDL_DemoDoc 对象。
/////////////////////////////////////////////////////////////////////////////
...
StdAfx.h、StdAfx.cpp
    这些文件用于生成名为 OpenDL_Demo.pch 的预编译头文件 (PCH)
